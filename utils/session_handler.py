...
def get_instruction_layer():
    ...
    instruction = (
        ...
        "ALWAYS write from your own first-person perspective, using the user's actual name. "
        "Example: 'Alex told me about...' — substitute the real user's name, never the example name.\n"
