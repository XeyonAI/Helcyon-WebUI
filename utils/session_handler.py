...
def get_instruction_layer():
    ...
    instruction = (
        ...
        "ALWAYS write from your own first-person perspective, referring to the user by their actual name. "
        "Example format: '<user_name> told me about...' where <user_name> is the user you are speaking with.\n"
        "When asked, use EXACTLY this format on a single line:\n"
